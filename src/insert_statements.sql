...
-- Seen
INSERT INTO seen(dog_id, seen_dog_id, liked, ts) VALUES
...
-- Message
INSERT INTO message(time_sent, content, flag, dog_id1, dog_id2) VALUES
('2019-03-27 10:38:43', 'Hi Alex! I am Tim. When can Tucker and Max meet?', 1, 3, 1),
('2019-03-27 16:23:33', 'Hi Tim! We are available tomorrow at 2 pm', 0, 1, 1),
('2019-04-01 18:25:00', 'Hello. Luna is excited to meet Tucker!', 1, 2, 2),
('2019-04-02 13:50:16', 'Hi Sarah!', 0, 3, 2);
